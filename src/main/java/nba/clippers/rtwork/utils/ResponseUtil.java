package nba.clippers.rtwork.utils;
 ...
 * </ul>
 * <li> 6xx，小商城后端业务错误码，
 * 具体见market-admin-api模块的AdminResponseCode。
 * <li> 7xx，管理后台后端业务错误码，
 * 具体见market-wx-api模块的WxResponseCode。
 * </ul>
 */
public class ResponseUtil {
    ...
    public static Object telNumberError() {
        Map<String, Object> obj = new HashMap<String, Object>();
        obj.put("errno", 402);
        obj.put("errmsg", "请输入11位手机");
//        obj.put("data",null)
        return obj;
    }
    public static Object areaNumberError() {
        Map<String, Object> obj = new HashMap<String, Object>();
        obj.put("errno", 402);
        obj.put("errmsg", "请输入省市区");
//        obj.put("data",null)
        return obj;
    }
    ...
    public static Object wrong(){
        return fail(601, "用户名、密码错误");
    }

    public static Object received(){
        return fail(701, "优惠券已经领取过");
    }

    public static Object expired(){return fail(707, "优惠券已过期");}

    public static Object fullCoupon(){
        return fail(740, "优惠券已领完");
    }

    public static Object exchanged(){return fail(741, "优惠券已兑换");}

    public static Object wrongCoupon() {return fail(742, "优惠券不正确");
    }
}
